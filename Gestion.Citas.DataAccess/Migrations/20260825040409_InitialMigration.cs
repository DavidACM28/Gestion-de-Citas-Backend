    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentBlock", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentBlock_Doctor_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    EndTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    AppointmentDurationMin = table.Column<int>(type: "int", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessHours_Doctor_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentBlock_DoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlot_DoctorId_Date_Time",
                table: "AppointmentSlot",
                columns: new[] { "DoctorId", "Date", "Time" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BusinessHours_DoctorId_DayOfWeek",
                table: "BusinessHours",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patient_DocumentNumber",
                table: "Patient",
